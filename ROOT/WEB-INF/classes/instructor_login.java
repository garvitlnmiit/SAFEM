...
public class instructor_login extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse res)
		...
		user.name=req.getParameter("usr");		//session start
		...
		if(RS.next())
		{
			...
			out.println("<form action='/course_s' method='post'>");
				...
				out.println("<tr><th>Courses:</th><th>Evaluation</th></tr>");
				//}
				while(RS1.next())
				{	
					count++;
					out.println("<tr><td align='center'>"+RS1.getString(2)+"</td>");
					out.println("<td align='center'><input type='radio' required='required' name='courses' value='"+RS1.getString(1)+"'></td></tr>");
				...
				out.println("<tr><td colspan='2'><input type='submit'/></td></tr></table></form>");	
				}
